...
def test_init_parameters(train_data=train_data, train_truth=train_truth, test_data=test_data, , test_truth=test_truth):
    dm = DenMune(train_data=train_data, train_truth=y_cc, k_nearest=10)
